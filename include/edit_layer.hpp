...
private:
    ...
    void render_line_number(SDL_Renderer *renderer, size_t line_number, int x, int y);
    void render_cursor(SDL_Renderer *renderer, int w, int h, int x, int y, std::string_view sv, std::string_view::iterator cursor);
